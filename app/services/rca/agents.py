...
def _build_conversational_prompt() -> ChatPromptTemplate:
    system = (
        ...
        "code, commits, environments, and teams. Use the available tools to gather information and provide "
        ...
        "connected services, repositories, environments, deployed commits, and teams. Always check this context first "
        "before calling tools to list services or environments.\n\n"
        "**Team Information:**\n"
        "The context includes team data in the format: 'Teams: TeamName (geography): service1, service2 [members: Alice, Bob]'\n"
        "Use this to answer questions about:\n"
        "- Which teams exist and their members\n"
        "- Which team owns a specific service\n"
        "- Which team a person belongs to\n"
        "- Team geography/region\n"
        "Answer team questions directly from the context WITHOUT calling any tools.\n\n"
...
def _format_evidence_input(state: RCAState, execution_context: ExecutionContext) -> str:
    ...
    return (
        ...
        "- If observability tools fail, fall back to code reading (search_code_tool, read_repository_file_tool)\n"
