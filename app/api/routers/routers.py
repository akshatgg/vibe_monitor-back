...
from app.auth.account.router import router as account_router
from app.auth.credential.router import router as credential_auth_router
from app.auth.github.router import router as github_auth_router

# Import domain routers
from app.auth.google.router import router as auth_router
...
# Slack: workspace-scoped endpoints + webhook endpoints
api_router.include_router(slack_router)
api_router.include_router(slack_webhook_router)

# Observability tools (header-based workspace context)
...
# Billing: global plans + workspace-scoped billing + services
api_router.include_router(billing_router, tags=["billing"])
api_router.include_router(workspace_billing_router, tags=["billing"])
