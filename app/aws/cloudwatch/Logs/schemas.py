...
class LogGroupInfo(BaseModel):
    ...
    logGroupClass: str = Field(..., description="Log group class (STANDARD or INFREQUENT_ACCESS)")
    logGroupArn: str = Field(..., description="Full log group ARN")
    metricFilterCount: Optional[int] = Field(None, description="Number of metric filters")
...
class ListLogGroupsRequest(BaseModel):
    ...
    logGroupNamePrefix: Optional[str] = Field(None, description="Filter log groups by name prefix")
    limit: Optional[int] = Field(100, description="Maximum number of log groups to return (default: 100)", ge=1, le=100)
...
class LogStreamInfo(BaseModel):
    ...
    firstEventTimestamp: Optional[int] = Field(None, description="Timestamp of first event")
    lastEventTimestamp: Optional[int] = Field(None, description="Timestamp of last event")
    lastIngestionTime: Optional[int] = Field(None, description="Last ingestion timestamp")
...
class ListLogStreamsRequest(BaseModel):
    ...
    logStreamNamePrefix: Optional[str] = Field(None, description="Filter streams by name prefix")
    descending: Optional[bool] = Field(True, description="Descending order")
    limit: Optional[int] = Field(100, description="Maximum number of streams to return (default: 100)", ge=1, le=100)
...
class GetLogEventsRequest(BaseModel):
    ...
    logGroupName: str = Field(..., description="Log group name")
    logStreamName: str = Field(..., description="Log stream name")
    limit: Optional[int] = Field(100, description="Maximum number of events to return (default: 100)", ge=1, le=1000)
    startTime: Optional[int] = Field(None, description="Start time in milliseconds since epoch")
    endTime: Optional[int] = Field(None, description="End time in milliseconds since epoch")
...
class StartQueryRequest(BaseModel):
    ...
    limit: Optional[int] = Field(1000, description="Maximum number of results", ge=1, le=10000)
...
class GetQueryResultsResponse(BaseModel):
    ...
    status: str = Field(..., description="Query status: Scheduled, Running, Complete, Failed, Cancelled")
...
class FilterLogEventsRequest(BaseModel):
    ...
    logGroupName: str = Field(..., description="Log group name")
    logStreamNames: Optional[List[str]] = Field(None, description="List of log stream names to filter")
    startTime: Optional[int] = Field(None, description="Start time in milliseconds since epoch")
    endTime: Optional[int] = Field(None, description="End time in milliseconds since epoch")
    filterPattern: Optional[str] = Field(None, description="Filter pattern for log events")
    limit: Optional[int] = Field(100, description="Maximum number of events (default: 100)", ge=1, le=1000)
...
class FilterLogEventsResponse(BaseModel):
    ...
    searchedLogStreams: Optional[List[dict]] = Field(None, description="Log streams that were searched")
