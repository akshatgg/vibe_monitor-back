...
class AWSIntegrationResponse(BaseModel):
    ...
    has_external_id: bool = Field(..., description="Whether an external ID is configured")
    ...
    credentials_expiration: Optional[datetime] = Field(None, description="When temporary credentials expire")
